...
class UpdatePassState extends State<UpdatePass> {
  ...
  final FocusNode myFocusNodePasswordOld = FocusNode();
  ...
  void dispose() {
    ...
    myFocusNodePasswordOld.dispose();
            ...
            children: <Widget>[
              Padding(
                ...
                child: new Image(
                    ...
                    fit: BoxFit.fill,
                    image:
                        new AssetImage('assets/img/merchant_createPass.png')),
              ),
              Container(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.only(
                                      ...
                                      right: 25.0),
                                  child: TextField(
                                    focusNode: myFocusNodePasswordOld,
  ...
  Future<void> validateData() async {
    ...
    if (oldPasswordController.text.isEmpty) {
      showInSnackBar("Please enter Current Password", 2);
      return null;
    }
    ...
    if (passwordController.text.isEmpty) {
      showInSnackBar("Please enter New Password", 2);
      return null;
    }
    ...
    if (oldPasswordController.text == passwordController.text) {
      showInSnackBar("Please do not use Current Password as New Password", 2);
      return null;
    }
    ...
    final response = await http.post(
      "http://157.230.228.250/merchant-change-password-api/",
      body: param,
    ...
    password = new CommonData.fromJson(jsonDecode(response.body));
    ...
    if (response.statusCode == 200) {
      if (password.status == "success") {
        ...
        showInSnackBar("Password Change Successfully", 2);
      } else
