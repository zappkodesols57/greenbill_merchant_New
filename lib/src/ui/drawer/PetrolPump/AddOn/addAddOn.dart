...
class AddAddon extends StatefulWidget {
  ...
  AddAddon(this.status, this.id, this.productAvailability, this.productCost, this.productName);

  @override
  AddAddonState createState() => AddAddonState();
}

class AddAddonState extends State<AddAddon> {
  ...
  void saveProduct() async {
    ...
    final response = await http.post(
      "http://157.230.228.250/petrol-ad-on-products-api/",
