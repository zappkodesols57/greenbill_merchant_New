...
class AppColors {
  static const Color kPrimaryColor = Color(0xFF60C878);
  static const Color kPrimaryColorBlue = Color(0xFF00569D);
  static const Color kPrimaryColorDarkBlue = Color(0xFF004781);
  static const Color kPrimaryColorGreen = Color(0xFF63B90B);
  static const Color kPrimaryColorRed = Colors.red;
  static const Color kPrimaryColorRedDark = Color(0xFFC81018);
  static const Color kPrimaryColorRedExtraDark = Color(0xFFA81017);
  static const Color kSecondaryColor = Color(0xFFB8E0C8);
  static const Color kTransperent = Color(0xFFE0E0E0);
  static const Color kPrimaryLightColor = Color(0xFFD6F0E5);
